...
module.exports = middlewares = {
  authenticateToken: async (req, res, next) => {
    try {
      ...
      if (!token) {
        return response.returnFalse(req, res, res.translate('token_required_for_auth'), {});
      }
      ...
      try {
        ...
        let error_code=461
        return response.returnFalse(req, res, res.translate('invalid_token'), {},error_code);
      }
  ...
  version: async (req, res, next) => {
    try {
      ...
      console.log(e);
      return response.returnFalse(req, res, res.translate('validation_error_message'), {});
    }
  },
};
